                ...
                <div className="container">
                    <div className="content">
                        ...
                        <div className="info-headers">
                            <h2 className="info-header important-text"><a href={`https://URLWords.dreamhosters.com/${shortUrl}`}>{ shortUrl.length > 0 && "https://URLWords.dreamhosters.com/" }<strong>{ shortUrl }</strong></a></h2>
